...
class FertileOptInScreen extends StatelessWidget {
  ...
  Future<void> _completeOnboarding(BuildContext context, OnboardingData finalData) async {
    if (finalData.lastPeriod != null && finalData.track != null && finalData.fertile != null) {
      final profile = CycleProfile(
        track: finalData.track!,
        lastPeriod: finalData.lastPeriod!,
        fertile: finalData.fertile!,
      );
          ...
          child: Column(
            ...
            children: [
              ...
              CircaChoiceCard(
                ...
                onTap: () => _completeOnboarding(context, data.copyWith(fertile: true)),
              ),
              const SizedBox(height: 16),
              CircaChoiceCard(
                ...
                onTap: () => _completeOnboarding(context, data.copyWith(fertile: false)),
              ),
            ],
          ),
        ),
