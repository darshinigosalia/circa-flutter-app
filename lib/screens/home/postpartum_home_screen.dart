...
import '../track/symptoms_sub_screen.dart';
import '../charts/charts_screen.dart';
import '../common/circa_drawer.dart';
import 'package:circa_app/utils/app_clock.dart';

class PostpartumHomeScreen extends StatefulWidget {
  final StorageService storage;

  const PostpartumHomeScreen({super.key, required this.storage});

  @override
  State<PostpartumHomeScreen> createState() => _PostpartumHomeScreenState();
}

class _PostpartumHomeScreenState extends State<PostpartumHomeScreen> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("One day at a time", style: CircaColors.title),
                      const SizedBox(height: 6),
                      Text(
                        "Congratulations, and welcome to the fourth trimester. Let's gently keep an eye on your recovery, with no pressure at all.",
                      ...
                      Row(
                        ...
                        children: [
                          Text("TODAY'S GENTLE CHECK-IN", style: CircaColors.eyebrow),
                          TextButton(
                            onPressed: () {
                      ...
                      Container(
                        ...
                        child: Text(
                          "We've paused cycle predictions while your body recovers. Periods can take a while to return, especially if you're nursing, and that's completely normal.",
